export const data = {
  ...
  steps: [
    ...
    "Cook the omelette: Once the butter is melted and bubbling,, pour in the eggs. Tilt the pan to ensure he eggs evenly coat the surface.",
    "Add the fillings: When the eggs begin to set at the edges but are still slightly runny in the middle, sprinkle your chosen fillings over one half of the omelette.",
